...
<div class="slider-area">
    ...
    <div id="about" class="section wb">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="post-media wow fadeIn">
                        <img src="<?php bloginfo('template_url'); ?>/uploads/about_01.jpg" alt="" class="img-responsive img-rounded">
            ...
            <div class="row">
				<div class="col-md-6">
                    <div class="post-media wow fadeIn">
                        <img src="<?php bloginfo('template_url'); ?>/uploads/about_02.jpg" alt="" class="img-responsive img-rounded">
                    </div><!-- end media -->
                </div><!-- end col -->
	...
	<div class="parallax section parallax-off" data-stellar-background-ratio="0.9" style="background-image:url('<?php bloginfo('template_url'); ?>/uploads/parallax_04.jpg');">
        <div class="container">
        ...
        <div class="container">
            ...
            <div class="owl-services owl-carousel owl-theme">
                <div class="service-widget">
                    <div class="post-media wow fadeIn">
                        <a href="<?php bloginfo('template_url'); ?>/uploads/service_01.jpg" data-rel="prettyPhoto[gal]" class="hoverbutton global-radius"><i class="flaticon-unlink"></i></a>
                        <img src="<?php bloginfo('template_url'); ?>/uploads/service_01.jpg" alt="" class="img-responsive img-rounded">
                    </div>
                ...
                <div class="service-widget">
                    <div class="post-media wow fadeIn">
                        <a href="<?php bloginfo('template_url'); ?>/uploads/service_02.jpg" data-rel="prettyPhoto[gal]" class="hoverbutton global-radius"><i class="flaticon-unlink"></i></a>
                        <img src="<?php bloginfo('template_url'); ?>/uploads/service_02.jpg" alt="" class="img-responsive img-rounded">
                    </div>
					<div class="service-dit">
                ...
                <div class="service-widget">
                    <div class="post-media wow fadeIn">
                        <a href="<?php bloginfo('template_url'); ?>/uploads/service_03.jpg" data-rel="prettyPhoto[gal]" class="hoverbutton global-radius"><i class="flaticon-unlink"></i></a>
                        <img src="<?php bloginfo('template_url'); ?>/uploads/service_03.jpg" alt="" class="img-responsive img-rounded">
                    </div>
					<div class="service-dit">
                ...
                <div class="service-widget">
                    <div class="post-media wow fadeIn">
                        <a href="<?php bloginfo('template_url'); ?>/uploads/service_04.jpg" data-rel="prettyPhoto[gal]" class="hoverbutton global-radius"><i class="flaticon-unlink"></i></a>
                        <img src="<?php bloginfo('template_url'); ?>/uploads/service_04.jpg" alt="" class="img-responsive img-rounded">
                    </div>
					<div class="service-dit">
    ...
    <div class="parallax section noover" data-stellar-background-ratio="0.7" style="background-image:url('<?php bloginfo('template_url'); ?>/uploads/parallax_05.png');">
        <div class="container">
            <div class="row text-center">
				...
				<div class="col-md-6">
                    <div class="text-center image-center hidden-sm hidden-xs">
                        <img src="<?php bloginfo('template_url'); ?>/uploads/device_03.png" alt="" class="img-responsive wow fadeInUp">
                    </div>
                </div>
            </div><!-- end row -->
        </div><!-- end container -->
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-4 hidden-xs hidden-sm">
                    <img src="<?php bloginfo('template_url'); ?>/uploads/ipad.png" class="img-center img-responsive" alt="">
                </div>
                <div class="col-md-4 col-sm-6 col-xs-12">
    ...
    <div id="testimonials" class="parallax section db parallax-off" style="background-image:url('<?php bloginfo('template_url'); ?>/uploads/parallax_03.jpg');">
        <div class="container">
            <div class="section-title text-center">
                <h3>Testimonials</h3>
                    ...
                    <div class="testi-carousel owl-carousel owl-theme">
                        <div class="testimonial clearfix">
                            ...
                            <div class="testi-meta">
                                <img src="<?php bloginfo('template_url'); ?>/uploads/testi_01.png" alt="" class="img-responsive alignleft">
                        ...
                        <div class="testimonial clearfix">
                            ...
                            <div class="testi-meta">
                                <img src="<?php bloginfo('template_url'); ?>/uploads/testi_02.png" alt="" class="img-responsive alignleft">
                        ...
                        <div class="testimonial clearfix">
                            ...
                            <div class="testi-meta">
                                <img src="<?php bloginfo('template_url'); ?>/uploads/testi_03.png" alt="" class="img-responsive alignleft">
            ...
            <div class="row logos">
                <div class="col-md-2 col-sm-2 col-xs-6 wow fadeInUp">
                    <a href="#"><img src="<?php bloginfo('template_url'); ?>/uploads/logo_01.png" alt="" class="img-repsonsive"></a>
                </div>
                <div class="col-md-2 col-sm-2 col-xs-6 wow fadeInUp">
                    <a href="#"><img src="<?php bloginfo('template_url'); ?>/uploads/logo_02.png" alt="" class="img-repsonsive"></a>
                </div>
                <div class="col-md-2 col-sm-2 col-xs-6 wow fadeInUp">
                    <a href="#"><img src="<?php bloginfo('template_url'); ?>/uploads/logo_03.png" alt="" class="img-repsonsive"></a>
                </div>
                <div class="col-md-2 col-sm-2 col-xs-6 wow fadeInUp">
                    <a href="#"><img src="<?php bloginfo('template_url'); ?>/uploads/logo_04.png" alt="" class="img-repsonsive"></a>
                </div>
                <div class="col-md-2 col-sm-2 col-xs-6 wow fadeInUp">
                    <a href="#"><img src="<?php bloginfo('template_url'); ?>/uploads/logo_05.png" alt="" class="img-repsonsive"></a>
                </div>
                <div class="col-md-2 col-sm-2 col-xs-6 wow fadeInUp">
                    <a href="#"><img src="<?php bloginfo('template_url'); ?>/uploads/logo_06.png" alt="" class="img-repsonsive"></a>
                </div>
            </div><!-- end row -->
